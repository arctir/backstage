...
> {
  ...
  logout?(options: {req: Request, res: Response}, ctx: { logoutRedirectUrl?: string }): TLogoutResult;
}

/** @public */
export function createProxyAuthenticator<TContext, TResult, TProviderInfo, TLogoutResult>(
  authenticator: ProxyAuthenticator<TContext, TResult, TProviderInfo, TLogoutResult>,
